    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-neutral-400">{unreadCount} unread notification{unreadCount !== 1 ? "s" : ""}</p>
        </div>
          ...
          filtered.map((notif, i) => {
            ...
            return (
              ...
              >
                ...
                {!notif.read && (
                  <button onClick={() => handleMarkRead(notif.id)} className="rounded-lg p-2 text-neutral-500 opacity-0 transition hover:text-white group-hover:opacity-100">
