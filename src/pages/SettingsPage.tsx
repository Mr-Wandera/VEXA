...
export default function SettingsPage() {
  ...
  if (loading) return <div className="space-y-6"><div className="h-8 w-32 rounded-lg shimmer" /><div className="h-96 rounded-2xl shimmer" /></div>;
      ...
      <form onSubmit={handleSave} className="max-w-2xl space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input id="biz-name" type="text" value={profile.name} onChange={(e) => setProfile({ ...profile, name: e.target.value })}
                  className="auth-input w-full rounded-xl border border-neutral-800 bg-neutral-950 py-3 pl-11 pr-4 text-sm text-white focus:border-primary-500 focus:outline-none" />
              </div>
            </div>
            <div>
              ...
              <input id="biz-industry" type="text" value={profile.industry} onChange={(e) => setProfile({ ...profile, industry: e.target.value })}
                className="auth-input w-full rounded-xl border border-neutral-800 bg-neutral-950 px-4 py-3 text-sm text-white focus:border-primary-500 focus:outline-none" />
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input id="biz-tax" type="number" min="0" max="100" value={profile.taxRate} onChange={(e) => setProfile({ ...profile, taxRate: Number(e.target.value) })}
                    className="auth-input w-full rounded-xl border border-neutral-800 bg-neutral-950 py-3 pl-11 pr-4 text-sm text-white focus:border-primary-500 focus:outline-none font-mono" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex justify-end">
          <button type="submit" disabled={saving}
            className="flex items-center gap-2 rounded-xl bg-primary-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-primary-600/20 transition hover:bg-primary-500 disabled:opacity-50">
